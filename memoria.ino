...
//  dueFlashStorage.write(kezdocim + 105,  oplfo );
  ...
  dueFlashStorage.write(kezdocim + 123, chorusfreq );
  dueFlashStorage.write(kezdocim + 124,  choruslevel);
}
...
//  oplfo  = dueFlashStorage.read(kezdocim + 105);
  ...
  chorusfreq = dueFlashStorage.read(kezdocim + 123);
  choruslevel  = dueFlashStorage.read(kezdocim + 124);
}

...
#define op1attackinit(op1al, i, op1ar)(op1al*i*i/(op1ar*op1ar))
#define op2attackinit(op2al, i, op2ar)(op2al*i*i/(op2ar*op2ar))
#define op3attackinit(op3al, i, op3ar)(op3al*i*i/(op3ar*op3ar))
#define op4attackinit(op4al, i, op4ar)(op4al*i*i/(op4ar*op4ar))
#define op5attackinit(op5al, i, op5ar)(op5al*i*i/(op5ar*op5ar))
#define op6attackinit(op6al, i, op6ar)(op6al*i*i/(op6ar*op6ar))
